  ...
  <div class="ls-sidebar-inner">
      ...
      <nav class="ls-menu">
        <ul>
           ...
           <li>
            <a href="#" class="ls-ico-cog" title="Cadastros">Cadastros</a>
            <ul>
	...
	<div class="container-fluid">
		...
		<div class="ls-txt-right">
		   <button data-ls-module="modal" data-target="#myAwesomeModal" class="ls-btn-primary"> <span class="ls-ico-user-add"> </span> Cadastrar novo usuário</button>
		</div>
		<!-- Grid de registros -->
...
<div id="PersonTableContainer"></div>
	  <tbody>
	    <tr>
	      <td>Claudio da silva sauro</td>
	      <td>claudio@anbertec.com</td>
	      <td>Cl4ud10</td>
		    ...
		    <div class="ls-modal-body">
			  <fieldset>
			    <label class="ls-label col-md-4 col-xs-12">
				   ...
				   <input type="text" name="nomeUsuario" placeholder="Digite o seu nome" class="ls-field" required>
			    </label>
			    <label class="ls-label col-md-4 col-xs-12">
				   <b class="ls-label-text">Email do usuário</b>
				   <input type="email" name="email" placeholder="Digite o seu email" class="ls-field" required>
			    </label>
			    <label class="ls-label col-md-4 col-xs-12">
				   <b class="ls-label-text">Usuário</b>
				   <input type="text" name="usuario" placeholder="Digite seu usuário" class="ls-field" required>
			    </label>
			    <label class="ls-label col-md-4 col-xs-12">
				   <b class="ls-label-text">Senha</b>
				   <input type="password" name="senhaUsuario" placeholder="Digite sua senha" class="ls-field" required>
			    </label>
			  </fieldset>		      
		    </div>
    ...
    <script src="javascripts/locastyle.js" type="text/javascript"></script>
 	 ...
 	 $.ajax({
		url:'http://localhost:8080/gFinanceiro/usuario',
		method:'GET',
		cache:false,
		data:{metodo:'listar'},
